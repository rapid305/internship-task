...
from app.api.v1.analytics import get_transaction_analysis_result, run_analysis
...
class TestAnalyticsEndpoints:
    ...
    async def test_run_analysis_success(self):
        ...
        with patch("app.api.v1.analytics.get_transaction_analysis.kiq") as mock_kiq:
            mock_task = AsyncMock()
    ...
    async def test_get_result_completed(self):
        ...
        with patch("app.api.v1.analytics.broker.result_backend.get_result") as mock_get_result:

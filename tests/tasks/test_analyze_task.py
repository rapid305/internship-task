...
from app.tasks.analyze_task import get_transaction_analysis, has_non_zero_metrics
...
class TestAnalyzeTask:
    ...
    async def test_get_transaction_analysis_filters_zero_weeks(self):
        ...
        with patch("app.tasks.analyze_task.WEEKS", 4), patch("app.tasks.analyze_task.DAYS", 7), patch(
            "app.tasks.analyze_task.async_session_maker"
        ) as mock_session_maker, patch("app.tasks.analyze_task.get_metrics") as mock_get_metrics, patch(
            "app.tasks.analyze_task.datetime"
        ) as mock_datetime:
    ...
    async def test_get_transaction_analysis_sorts_by_week_number(self):
        ...
        with patch("app.tasks.analyze_task.WEEKS", 3), patch("app.tasks.analyze_task.DAYS", 7), patch(
            "app.tasks.analyze_task.async_session_maker"
        ) as mock_session_maker, patch("app.tasks.analyze_task.get_metrics") as mock_get_metrics, patch(
            "app.tasks.analyze_task.datetime"
        ) as mock_datetime:
    ...
    async def test_get_transaction_analysis_returns_correct_structure(self):
        ...
        with patch("app.tasks.analyze_task.WEEKS", 1), patch("app.tasks.analyze_task.DAYS", 7), patch(
            "app.tasks.analyze_task.async_session_maker"
        ) as mock_session_maker, patch("app.tasks.analyze_task.get_metrics") as mock_get_metrics, patch(
            "app.tasks.analyze_task.datetime"
        ) as mock_datetime:
